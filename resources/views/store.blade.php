              ...
              <div class="pt-3">
                ...
                <ul class="mt-2 flex items-center gap-4">
                  <li class="flex items-center gap-2">
                    ...
                    <p class="text-sm font-medium text-gray-500 dark:text-gray-400">Placeholder Category</p>
                  </li>
                </ul>
                
                <!-- Price & Add To Cart -->
                <p class="text-lg pt-1 font-extrabold leading-tight text-gray-900 dark:text-white">Rp10.699.000</p>
